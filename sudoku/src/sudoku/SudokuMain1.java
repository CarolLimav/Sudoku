 ...
 */
public class SudokuMain1 extends JFrame {
   private static final long serialVersionUID = 1L;  // to prevent serial warning
   private static SudokuMain1 instance;
   ...
   public void updateErroLabel() {
	        ...
	        if (Player.getErros() == 3) {
	            JOptionPane.showMessageDialog(SudokuMain1.this,
  ...
  public void updateScoreLabel() {
   ...
   public static SudokuMain1 getInstance() {
	   if(instance == null)
		   instance = new SudokuMain1();
	   return instance;
   }
